...
def def_home_page():
    if 'user_id' in session:
        return redirect(url_for('def_register_page'))
...
def def_dashboard():
    ...
    return render_template('dashboard.html', email=user.email, username=user.username,level=user.level, xp=user.xp, tasks=tasks, random_tip=random_tip, t=t)
